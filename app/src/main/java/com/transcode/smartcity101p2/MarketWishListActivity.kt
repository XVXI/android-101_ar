...
class MarketWishListActivity : CoreActivity(), WishListAdapter.ClickItemListener, MarketWishListActivityContract.View {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val img = ContextCompat.getDrawable(this, R.mipmap.market_icon_fav_header)
    ...
    override fun onClickDetail(res: GetProductResponse.GetProductResponseData) {
        ...
        val productDialog = ProductDialog(this)
