...
import kotlinx.android.synthetic.main.item_callphone.view.*

class CallPhoneAdapter(var context: Context) : AppBaseAdapter() {

    var list = arrayListOf<CallPhoneResponse.CallPhoneData>()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = inflater.inflate(R.layout.item_callphone, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.title.text = data.Callname
    ...
    fun setData(list: ArrayList<CallPhoneResponse.CallPhoneData>) {
        this.list = list
    }
    ...
    interface ClickItem {
        fun onclickItem(res: CallPhoneResponse.CallPhoneData)
    }
}