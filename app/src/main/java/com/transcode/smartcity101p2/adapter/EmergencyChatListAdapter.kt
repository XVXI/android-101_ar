...
class EmergencyChatListAdapter(var context: Context) : AppBaseAdapter() {

    var list = arrayListOf<EmergencyByIDResponse.EmergencyByIDResponseDialog>()
    ...
    fun setData(list: ArrayList<EmergencyByIDResponse.EmergencyByIDResponseDialog>) {
        this.list = list
    }
    ...
    interface ClickItem {
        fun onclickItem(res: EmergencyByIDResponse.EmergencyByIDResponseDialog)
    }
