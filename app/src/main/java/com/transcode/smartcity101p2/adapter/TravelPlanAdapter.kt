...
class TravelPlanAdapter(var context: Context, var fragmentManager: FragmentManager?) : AppBaseAdapter() {
...
//        fragmentManager?.let {
//            FragmentHelper.replaceWithoutAddingToBackStack(it, TravelPlanFragment.newInstance(), R.id.sub_menu_content)
//        }
    }
