...
class NewsAdapter(var context: Context, var fragmentManager: FragmentManager?) : AppBaseAdapter() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = inflater.inflate(R.layout.blank_frame2, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        fragmentManager?.let {
            FragmentHelper.replaceWithoutAddingToBackStack(it, NewsFragment.newInstance("", ""), R.id.sub_menu_content2)
        }
    }
