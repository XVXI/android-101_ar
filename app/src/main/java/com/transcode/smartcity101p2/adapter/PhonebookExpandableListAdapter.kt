...
class PhonebookExpandableListAdapter(var context: Context) : BaseExpandableListAdapter() {

    var expandableListTitle = arrayListOf<HashMap<String, String>>()
    var expandableListDetail = HashMap<String, ArrayList<CallPhoneResponse.CallPhoneData>>()
    ...
    fun setChildData(child: HashMap<String, ArrayList<CallPhoneResponse.CallPhoneData>>) {
        expandableListDetail = child
    }

    fun getAllChild(groupPosition: Int): ArrayList<CallPhoneResponse.CallPhoneData> {
        val title = this.expandableListTitle[groupPosition]["title"].toString()
        return expandableListDetail[title] ?: arrayListOf()
    }

    fun updateChild(groupPosition: Int, list: ArrayList<CallPhoneResponse.CallPhoneData>) {
        val title = this.expandableListTitle[groupPosition]["title"].toString()
    ...
    override fun getChildView(listPosition: Int, expandedListPosition: Int,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.item_callphone, null)
        }
        ...
        val data = getChild(listPosition, expandedListPosition) as CallPhoneResponse.CallPhoneData

        expandedListTextView.text = data.Callname
    ...
    override fun getGroupView(listPosition: Int, isExpanded: Boolean,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.row_exp_phonebook_group, null)
        }
...
//        }
    ...
    interface ChildClickListener {
        fun onChildClick(groupPosition: Int, data: CallPhoneResponse.CallPhoneData)
    }

    interface PhoneBookListAdapterListener {

        fun onPhoneBookListClick(phonebookItem: CallPhoneResponse.CallPhoneData)
    }
}