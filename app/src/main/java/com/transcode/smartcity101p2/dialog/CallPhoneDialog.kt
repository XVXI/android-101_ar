...
import kotlinx.android.synthetic.main.dialog_callphone.view.*

class CallPhoneDialog(context: Context) : CoreDialog(context) {
    ...
    private fun initLayout() {
        ...
        b = inflater.inflate(R.layout.dialog_callphone, null, false)
        setContentView(b)
